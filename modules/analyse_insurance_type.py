...
async def analyze_relevant_pages_async(relevant_pages, ocr_results, add_padding=True):
    ...
    final_results = await extract_fields_by_insurance_type(redistributed_results, ocr_lookup)
    
    final_output = "./json/extracted_insurance_fields.json"
    print(f"  💾 Saving field extraction results to {final_output}...")
